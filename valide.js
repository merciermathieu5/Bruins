/* Harnais de validation — Bruins de Boston (jsdom) */
const fs = require('fs');
...
const ATTENDU = {
  equipe: 'BOSTON',
  taille: 23,
  echantillon: {nom: 'Teuvo Taravainen', salaire: 7200000, ct: 0, ov: 81},
  masseSousContrat: 73025000,
  nbSousContrat: 15,
  dateSecours: '8 juillet 2026',
  nbEchus: 8,
  nbBackups: 0,
  masseTotale: 100350000
};
...
(async () => {
  ...
  W.localStorage.removeItem('bos_resignatures_v1');
  W.localStorage.removeItem('bos_transac_v1');
